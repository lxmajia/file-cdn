 ...
 * @author Liao
 */
public class GithubCdnServer extends CdnServerAbstract {
    ...
    public GithubCdnServer(String token, String userId, String repos, String defaultBranch, Class<? extends BranchFileType> mappingClass) {
        this.accessToken = token;
        this.githubName = userId;
        this.repos = repos;
    ...
    @Override
    String getPrefixUrl() {
        return "https://api.github.com/repos/" + githubName + "/" + repos + "/contents/";
    }
    ...
    public Resp uploadFileBase64(String base64, String fileType) {
        String reqUrl = getReqUrl(UUID.randomUUID().toString(), fileType) + "?access_token=" + accessToken;
